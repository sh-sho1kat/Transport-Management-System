package com.tms.shared.error;

import com.tms.shared.api.response.Error;
import com.tms.shared.api.response.FieldError;
...
public class ApiErrors {
  public static Error body(String code, String message, List<FieldError> fields) {
    return new Error(code, message, fields, UUID.randomUUID().toString(), Instant.now());
  }
  ...
  ResponseEntity<Error> method(org.springframework.web.HttpRequestMethodNotSupportedException e) {
