...
import { ErrorBox, Empty, Loading, Pager, Badge } from "@/shared/ui/index.jsx";
        ...
        <div>
          ...
          <p>
            {audit
              ...
              : "Confirmed booking value includes paid and unpaid tickets. Collections are tracked separately."}
          </p>
        </div>
        {!audit && page && (
          <button
                ...
                audit ? (
                  ...
                  <tr key={r.tripId}>
                    ...
                    <td>
                      ...
                      <small>Confirmed ticket value</small>
                    </td>
                  </tr>
                ),
              )}
